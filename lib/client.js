...
function ChannelsSection(props) {
  ...
  const snapshot = (0, import_react.useSyncExternalStore)(
    (0, import_react.useCallback)((cb) => form.subscribe(cb), [form]),
    (0, import_react.useCallback)(() => form.getSnapshot(), [form])
  );
  ...
  const [noticeIsError, setNoticeIsError] = (0, import_react.useState)(false);
  ...
  const confirmTimer = (0, import_react.useRef)(null);
  const [cwdDraft, setCwdDraft] = (0, import_react.useState)(null);
  ...
  const activeQrSvg = (0, import_react.useMemo)(() => activeQr ? qrSvgFor(activeQr) : "", [activeQr]);
  ...
  const toggleEnabled = (0, import_react.useCallback)(async () => {
    if (!active) return;
    setBusy(true);
    setNotice("");
    setNoticeIsError(false);
  ...
  const saveDefaultCwd = (0, import_react.useCallback)(async () => {
    setBusy(true);
    setNotice("");
    setNoticeIsError(false);
    try {
  ...
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)(
      ...
      (0, import_react.createElement)(
        ...
        (0, import_react.createElement)("label", { style: labelStyle }, t("global.cwd")),
        (0, import_react.createElement)(
          "div",
        ...
        (0, import_react.createElement)("span", { style: { fontSize: "11px", opacity: 0.55 } }, t("global.cwdHint"))
      )
    ),
    (0, import_react.createElement)(
      "div",
      ...
      (0, import_react.createElement)(
        ...
        notice !== "" ? (0, import_react.createElement)("div", { style: { color: noticeIsError ? "#ff7a7a" : "#57d18a", fontSize: "12px", marginBottom: "8px" } }, notice) : null,
        creating !== null || active ? (0, import_react.createElement)(
          ...
          // config fields.
          currentType ? (0, import_react.createElement)(
            "div",
            { style: setupCalloutStyle },
            (0, import_react.createElement)("div", { style: { fontWeight: 600, fontSize: "12px", marginBottom: "4px" } }, t("channels.setup")),
            (0, import_react.createElement)("div", { style: { fontSize: "11.5px", opacity: 0.85, marginBottom: "6px" } }, t("type." + currentType + ".desc")),
            (0, import_react.createElement)(
              "ol",
              { style: { margin: 0, paddingLeft: "18px", fontSize: "11.5px", opacity: 0.9, display: "grid", gap: "3px" } },
              (SETUP_STEPS[currentType] ?? []).map(
                (stepKey) => (0, import_react.createElement)("li", { key: stepKey }, t(stepKey))
              )
            )
          ) : null,
          ...
          currentType === "wechat" ? (0, import_react.createElement)(
            "div",
            { style: { fontSize: "12px" } },
            activeQrSvg !== "" ? (0, import_react.createElement)(
              "div",
            ...
            ) : activeQr ? (0, import_react.createElement)("a", { href: activeQr, target: "_blank", rel: "noreferrer", style: { color: "#4f8cff" } }, t("channels.openQr")) : activeBound ? (0, import_react.createElement)("span", { style: { opacity: 0.75 } }, t("channels.bound")) : (0, import_react.createElement)("span", { style: { opacity: 0.75 } }, t("channels.qrHint"))
          ) : null,
          // Enable / disable switch (existing channels only; new ones start enabled).
          active && !creating ? (0, import_react.createElement)(
            "div",
          ...
          (0, import_react.createElement)(
            "div",
            { style: { borderTop: "1px solid rgba(128,128,128,0.18)", paddingTop: "8px" } },
            (0, import_react.createElement)("button", {
              type: "button",
              onClick: () => setAdvancedOpen(!advancedOpen),
              style: { ...ghostStyle, padding: "5px 12px", fontSize: "12px", border: "none", opacity: 0.8 }
            }, t("channels.advanced") + (advancedOpen ? " \u25B4" : " \u25BE")),
            advancedOpen ? (0, import_react.createElement)(
              "div",
              { style: { display: "grid", gap: "8px", marginTop: "8px" } },
              ADVANCED_KEYS.map((key) => (0, import_react.createElement)(
                "div",
                { key, style: { display: "grid", gap: "3px" } },
                (0, import_react.createElement)("label", { style: labelStyle }, t("advanced." + key)),
                key === "allowlist" ? (0, import_react.createElement)("textarea", {
                  rows: 3,
                ...
                (0, import_react.createElement)("span", { style: { fontSize: "11px", opacity: 0.55 } }, ADVANCED_HINTS[key] ?? "")
              ))
            ) : null
          ),
          (0, import_react.createElement)(
...
function ChannelsConfigEntry(props) {
  ...
  return (0, import_react2.createElement)("div", { style: pageStyle }, (0, import_react2.createElement)(ChannelsSection, { form, t }));
}
var pageStyle = {
  padding: "4px 0",
