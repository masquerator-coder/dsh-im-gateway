...
var zh = {
  ...
  "channels.setup": "\u63A5\u5165\u6B65\u9AA4",
  // 微信 token 单独不生效的说明（token 只是 ilink 网关凭证，不是微信侧的东西）。
  "type.wechat.tokenHint": "Token \u7531\u626B\u7801\u7ED1\u5B9A\u540E\u81EA\u52A8\u586B\u5165 ilink \u7F51\u5173\u51ED\u8BC1\uFF1B\u4EC5\u624B\u5DE5\u586B\u5165 Token \u5E76\u4E0D\u4F1A\u8FDE\u63A5\u5FAE\u4FE1\uFF0C\u4ECD\u9700\u5B8C\u6210\u4E0B\u9762\u7684\u626B\u7801\u4E0E\u89E3\u9501\u4E24\u6B65\u3002",
  // 各通道的接入指引步骤（编号从 1 开始自动拼接）。
  "setup.wechat.0": "\u4FDD\u5B58\u5E76\u542F\u7528\u901A\u9053\u540E\uFF0C\u6B64\u5904\u4F1A\u663E\u793A\u5FAE\u4FE1\u767B\u5F55\u4E8C\u7EF4\u7801",
  "setup.wechat.1": "\u7528\u4F60\u7684\u5FAE\u4FE1\u626B\u7801\uFF0C\u5728\u624B\u673A\u4E0A\u786E\u8BA4\u6388\u6743\u7ED1\u5B9A\u673A\u5668\u4EBA\u8D26\u53F7",
  "setup.wechat.2": "\u7ED1\u5B9A\u540E\u5728\u5FAE\u4FE1\u91CC\u7ED9\u673A\u5668\u4EBA\u53D1\u4E00\u6761\u4EFB\u610F\u6D88\u606F\uFF0C\u89E3\u9501\u53D1\u9001\u80FD\u529B",
  "setup.wechat.3": "\u4E4B\u540E\u5373\u53EF\u7528\u8BE5\u5FAE\u4FE1\u4E0E Agent \u5BF9\u8BDD\uFF08\u56DE\u590D\u4E5F\u53D1\u56DE\u8FD9\u4E2A\u5FAE\u4FE1\uFF09",
  "setup.qq.0": "\u5728 https://q.qq.com \u521B\u5EFA\u673A\u5668\u4EBA\uFF0C\u5E76\u5F00\u901A\u6240\u9700\u7684\u5355\u804A/\u7FA4\u804A\u6743\u9650\u5E76\u63D0\u4EA4\u5BA1\u6838",
  "setup.qq.1": "\u628A\u673A\u5668\u4EBA\u7684 AppID \u4E0E AppSecret \u586B\u5165\u4E0B\u65B9\u5B57\u6BB5",
  "setup.qq.2": "\u4FDD\u5B58\u542F\u7528\u540E\u5EFA\u7ACB WebSocket \u8FDE\u63A5\uFF1B\u672A\u5BA1\u6838\u901A\u8FC7\u524D\u8C03\u7528\u4F1A\u8FD4\u56DE\u6743\u9650\u9519\u8BEF\uFF08\u5C5E\u9884\u671F\uFF09",
  "setup.qq.3": "\u5355\u804A/\u7FA4\u804A\u56DE\u590D\u4E3A\u88AB\u52A8\u56DE\u590D\uFF0C\u9700\u643A\u5E26\u5BF9\u65B9\u53D1\u6765\u7684\u6D88\u606F ID",
  ...
  "type.wechat.desc": "\u5FAE\u4FE1\u4E2A\u4EBA\u53F7\u65E0\u5B98\u65B9\u63A5\u53E3\uFF0C\u76F4\u8FDE\u5B98\u65B9 ilink \u673A\u5668\u4EBA\u7F51\u5173\u3002\u9700\u626B\u7801\u7ED1\u5B9A\u4F60\u7684\u5FAE\u4FE1\uFF0C\u5E76\u53D1\u9001\u4E00\u6761\u6D88\u606F\u89E3\u9501\uFF08Token \u5728\u7ED1\u5B9A\u540E\u81EA\u52A8\u586B\u5165\uFF09\u3002",
  "type.qq.desc": "\u5B98\u65B9 QQ \u5F00\u653E\u5E73\u53F0\u673A\u5668\u4EBA\uFF0C\u586B\u5165 AppID \u4E0E AppSecret \u5373\u53EF\u63A5\u5165\uFF08WebSocket \u7F51\u5173\uFF09\u3002",
...
var en = {
  ...
  "type.wechat.tokenHint": "The Token is the ilink gateway credential auto-filled after QR binding; pasting a Token by hand does NOT connect WeChat \u2014 you still must complete the scan + unlock steps below.",
  "setup.wechat.0": "After saving and enabling the channel, a WeChat login QR appears here",
  "setup.wechat.1": "Scan it with your WeChat and confirm binding the bot account on your phone",
  "setup.wechat.2": "Once bound, send the bot any message in WeChat to unlock sending",
  "setup.wechat.3": "You can now chat with the agent from that WeChat (replies come back to it)",
  "setup.qq.0": "Create a bot at https://q.qq.com and apply for the needed C2C/group permissions (submission review)",
  "setup.qq.1": "Fill in the bot AppID and AppSecret below",
  "setup.qq.2": "Saving & enabling opens a WebSocket connection; calls fail with permission errors until review passes (expected)",
  "setup.qq.3": "C2C/group replies are passive and must carry the inbound msg ID",
  ...
  "type.wechat.desc": "Personal WeChat has no official API; talks directly to the official ilink bot gateway. Requires scanning to bind your WeChat and sending one message to unlock (the Token is auto-filled after binding).",
  "type.qq.desc": "Official QQ bot; fill AppID & AppSecret to connect (WebSocket gateway).",
...
var DEFAULT_QQ_API_BASE = "https://api.sgroup.qq.com";
    ...
    (0, import_react.createElement)(
      ...
      creating !== null || active ? (0, import_react.createElement)(
        ...
        currentType ? (0, import_react.createElement)(
          ...
          currentType === "wechat" ? (0, import_react.createElement)("div", { style: { fontSize: "11.5px", margin: "0 0 6px", color: "#e8b94a" } }, t("type.wechat.tokenHint")) : null,
          (0, import_react.createElement)(
            "ol",
        ...
        // The gateway hands over a URL whose page draws its own QR, so the
        // panel encodes that same URL locally (see ./qr.ts) — feeding it to
        // an <img src> only ever produced a broken image.
        currentType === "qq" || currentType === "wechat" ? (0, import_react.createElement)(
          ...
          ) : activeQr ? (0, import_react.createElement)("a", { href: activeQr, target: "_blank", rel: "noreferrer", style: { color: "#4f8cff" } }, t("channels.openQr")) : (0, import_react.createElement)("span", { style: { opacity: 0.75 } }, t("channels.qrHint"))
        ) : null,
        (0, import_react.createElement)(
          "div",
