...
var zh = {
  ...
  // 目录浏览（`浏览…` 按钮）。列目录必须由宿主进程完成——浏览器页面读不到
  // 文件系统，而且用户要选的是 Agent 真正运行的那台机器上的目录。
  "browse.open": "\u6D4F\u89C8\u2026",
  "browse.title": "\u9009\u62E9\u76EE\u5F55",
  "browse.close": "\u5173\u95ED",
  "browse.use": "\u4F7F\u7528\u6B64\u76EE\u5F55",
  ...
  "browse.roots": "\u5E38\u7528\u4F4D\u7F6E",
  "browse.manual": "\u76F4\u63A5\u586B\u5199\u8DEF\u5F84",
  "browse.enterPath": "\u8F93\u5165\u7EDD\u5BF9\u8DEF\u5F84\u540E\u56DE\u8F66",
  "browse.root.home": "\u7528\u6237\u76EE\u5F55",
  "browse.root.cwd": "\u63D2\u4EF6\u914D\u7F6E\u7684 cwd",
  "browse.root.imWorkspace": "\u9ED8\u8BA4 IM \u5DE5\u4F5C\u533A",
  "browse.unreadable": "\u65E0\u6CD5\u8FDB\u5165",
  "browse.currentIsFile": "\u8BE5\u8DEF\u5F84\u4E0D\u662F\u76EE\u5F55",
  "browse.inputHint": "\u4E5F\u53EF\u4EE5\u7528\u8D44\u6E90\u7BA1\u7406\u5668\u590D\u5236\u8DEF\u5F84\u540E\u7C98\u8D34\u5230\u5DE6\u4FA7\u8F93\u5165\u6846",
  "browse.failed": "\u8BFB\u53D6\u76EE\u5F55\u5931\u8D25",
  "channels.add": "\u65B0\u5EFA\u901A\u9053",
...
var en = {
  ...
  // Directory browser (the 浏览… button). The listing has to come from the host
  // process: a page cannot read the filesystem, and what the user picks is a
  // directory on the machine the agent actually runs on.
  "browse.open": "Browse\u2026",
  ...
  "browse.roots": "Places",
  "browse.manual": "Type a path",
  "browse.enterPath": "Type an absolute path and press Enter",
  "browse.root.home": "Home",
  "browse.root.cwd": "Plugin config cwd",
  "browse.root.imWorkspace": "Default IM workspace",
  "browse.unreadable": "Cannot open",
  "browse.currentIsFile": "That path is not a directory",
  "browse.inputHint": "You can also copy a path from your file manager and paste it into the box",
  "browse.failed": "Could not read the directory",
...
// src/client/bundle-name.ts
var BUNDLE_NAME = "dsh-im-gateway";
var ENTRY_ID = "im-gateway";
...
// src/client/write-field.ts
async function writeField(form, field, value, t) {
...
var BROWSE_ROUTE_PATH = "/im-gateway/browse";
...
function qrSvgFor(payload) {
  const text = (payload ?? "").trim();
  if (text === "") return "";
  try {
    const qr = qrcode_default(0, EC_LEVEL);
    qr.addData(text);
    qr.make();
...
function requiredMissing(type, template, editing, draft, provider) {
  const missing = [];
...
// src/client/DirectoryBrowser.tsx
var React = require("react");
var import_react = require("react");

// src/client/browse-client.ts
var defaultFetch = (url) => fetch(url, { credentials: "same-origin", cache: "no-store" });
function browseUrl(path) {
  if (path === "") return BROWSE_ROUTE_PATH;
  return `${BROWSE_ROUTE_PATH}?path=${encodeURIComponent(path)}`;
}
function normalizeBrowsePayload(raw) {
...
async function fetchDirectory(path, doFetch = defaultFetch) {
  try {
    ...
    if (!response.ok) {
      return {
        ...
        entries: [],
        roots: [],
        error: response.status === 401 || response.status === 403 ? "\u6CA1\u6709\u6743\u9650\u8BFB\u53D6\u76EE\u5F55\uFF08\u8BF7\u5237\u65B0\u9875\u9762\u540E\u91CD\u8BD5\uFF09" : `\u8BFB\u53D6\u76EE\u5F55\u5931\u8D25\uFF08HTTP ${response.status}\uFF09`
      };
    }
...
function breadcrumbs(path) {
  ...
  const crumbs = [];
  if (windows) {
    let current2 = parts[0] + separator;
    crumbs.push(current2);
    for (const part of parts.slice(1)) {
      current2 = current2.endsWith(separator) ? current2 + part : current2 + separator + part;
      crumbs.push(current2);
    }
    return crumbs;
  }
...
function directoryProblem(path, result) {
  if (path.trim() === "") return "";
  if (result === null || result.path !== path.trim()) return "";
  return result.error;
}

// src/client/DirectoryBrowser.tsx
var EMPTY = { path: "", parent: null, entries: [], roots: [], error: "" };
function DirectoryBrowser(props) {
  const { initialPath, onPick, onClose, t } = props;
  const [current, setCurrent] = (0, import_react.useState)(initialPath);
  const [result, setResult] = (0, import_react.useState)(EMPTY);
  const [loading, setLoading] = (0, import_react.useState)(true);
  const [typed, setTyped] = (0, import_react.useState)(initialPath);
  const requestSeq = (0, import_react.useRef)(0);
  const load = (0, import_react.useCallback)((path) => {
  ...
  const crumbs = (0, import_react.useMemo)(() => breadcrumbs(current), [current]);
  ...
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)(
      ...
      (0, import_react.createElement)(
        ...
        (0, import_react.createElement)("div", { style: { fontSize: "15px", fontWeight: 600 } }, t("browse.title")),
      ...
      crumbs.length > 0 ? (0, import_react.createElement)(
        "div",
        { style: { display: "flex", flexWrap: "wrap", alignItems: "center", gap: "2px", fontSize: "11.5px" } },
        crumbs.map(
          (crumb, index) => (0, import_react.createElement)(
            "span",
            { key: crumb, style: { display: "flex", alignItems: "center" } },
            index > 0 ? (0, import_react.createElement)("span", { style: { ...secondaryTextStyle, margin: "0 2px" } }, "\u203A") : null,
            (0, import_react.createElement)("button", {
              type: "button",
              onClick: () => {
                setTyped(crumb);
              ...
              style: crumb === crumbs[crumbs.length - 1] ? { ...crumbStyle, color: "var(--dsw-alias-label-primary)" } : crumbStyle,
              title: crumb
      ...
      result.roots.length > 0 ? (0, import_react.createElement)(
        "div",
        { style: { display: "flex", flexWrap: "wrap", alignItems: "center", gap: "6px" } },
        (0, import_react.createElement)("span", { style: { ...secondaryTextStyle, fontSize: "11px" } }, t("browse.roots") + ":"),
        result.roots.map(
          (root) => (0, import_react.createElement)("button", {
            key: root.id,
            type: "button",
            onClick: () => {
              setTyped(root.path);
      ...
      result.error !== "" ? (0, import_react.createElement)("div", { style: { fontSize: "12px", color: "var(--dsw-alias-state-error-primary)", wordBreak: "break-all" } }, result.error) : null,
      // Up + listing
      (0, import_react.createElement)(
        "div",
        ...
        (0, import_react.createElement)("span", { style: { ...secondaryTextStyle, fontSize: "11px" } }, t("browse.inputHint"))
      ),
      (0, import_react.createElement)(
        "div",
        { style: listStyle },
        loading && result.entries.length === 0 ? (0, import_react.createElement)("div", { style: { ...secondaryTextStyle, fontSize: "12px", padding: "8px" } }, t("browse.loading")) : result.entries.length === 0 && result.error === "" ? (0, import_react.createElement)("div", { style: { ...secondaryTextStyle, fontSize: "12px", padding: "8px" } }, t("browse.empty")) : result.entries.map((entry) => entryRow(entry, () => {
          setTyped(entry.path);
          load(entry.path);
        }, t))
      ),
...
function entryRow(entry, onOpen, t) {
  return (0, import_react.createElement)(
    "button",
    {
      key: entry.path,
    ...
    (0, import_react.createElement)("span", { style: { flex: "none", color: "var(--dsw-alias-label-secondary)" } }, "\u{1F4C1}"),
    (0, import_react.createElement)("span", { style: { flex: "1 1 0", minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" } }, entry.name),
    entry.readable ? null : (0, import_react.createElement)("span", { style: { flex: "none", fontSize: "10.5px", color: "var(--dsw-alias-label-caption)" } }, t("browse.unreadable"))
  );
}
...
var secondaryTextStyle = { color: "var(--dsw-alias-label-secondary)" };
...
var DEFAULT_WECHAT_BASE_URL = "https://ilinkai.weixin.qq.com";
var DEFAULT_CMCC_WSS = "wss://5gvas01.cmicmaap.com/gtw-ai/openclaw/ws/msg";
var DEFAULT_QQ_API_BASE = "https://api.bot.qq.com";
var ADVANCED_KEYS = ["allowlist", "provider", "model", "maxTokens", "cwd", "agentPreset"];
var SETUP_STEPS = {
...
function templatesFor() {
  ...
  const wechat = {
    // `baseUrl` only: there is no Token field. `bot_token` is an ilink gateway
    // credential the gateway issues at QR bind and the host persists to
    // `wechat-state/`, so a panel input for it could only ever invite a bogus
    // paste — and it is not what connects WeChat. (A hand-edited record may
    // still pre-seed `token`; the schema and the transport still accept it.)
...
function ChannelsSection(props) {
  const { form, t } = props;
  const TP = (0, import_react2.useMemo)(() => templatesFor(), []);
  const snapshot = (0, import_react2.useSyncExternalStore)(
    (0, import_react2.useCallback)((cb) => form.subscribe(cb), [form]),
    (0, import_react2.useCallback)(() => form.getSnapshot(), [form])
  );
  const channels = snapshot?.value?.channels ?? [];
  const hostCwd = snapshot?.value?.channelsCwd ?? "";
  const [activeId, setActiveId] = (0, import_react2.useState)(
    channels.length > 0 ? channels[0].id : void 0
  );
  const [creating, setCreating] = (0, import_react2.useState)(null);
  const [provider, setProvider] = (0, import_react2.useState)("custom");
  const [draft, setDraft] = (0, import_react2.useState)({});
  const [draftName, setDraftName] = (0, import_react2.useState)("");
  const [busy, setBusy] = (0, import_react2.useState)(false);
  const [notice, setNotice] = (0, import_react2.useState)("");
  const [noticeIsError, setNoticeIsError] = (0, import_react2.useState)(false);
  const [advancedOpen, setAdvancedOpen] = (0, import_react2.useState)(false);
  const [confirmingDelete, setConfirmingDelete] = (0, import_react2.useState)(false);
  const confirmTimer = (0, import_react2.useRef)(null);
  const [cwdDraft, setCwdDraft] = (0, import_react2.useState)(null);
  const [browsing, setBrowsing] = (0, import_react2.useState)(null);
  const [status, setStatus] = (0, import_react2.useState)({});
  const [statusLoaded, setStatusLoaded] = (0, import_react2.useState)(false);
  ...
  const activeQrSvg = (0, import_react2.useMemo)(() => activeQr ? qrSvgFor(activeQr) : "", [activeQr]);
  ...
  const activeSecretSet = active !== void 0 && creating === null && (template?.fields.some((f) => f.secret) ?? false);
  (0, import_react2.useEffect)(() => {
    ...
    for (const key of ADVANCED_KEYS) {
      const v = rec[key];
      if (key === "allowlist") {
        loaded.allowlist = Array.isArray(v) ? v.join("\n") : "";
        continue;
      }
      if (v !== void 0 && v !== null) loaded[key] = String(v);
    }
  ...
  const beginCreate = (0, import_react2.useCallback)((type) => {
    const tp = TP[type];
    const d = {};
  ...
  const select = (0, import_react2.useCallback)((id) => {
    setActiveId(id);
    setCreating(null);
    setConfirmingDelete(false);
    setBrowsing(null);
  }, []);
  const currentFields = (0, import_react2.useMemo)(() => {
  ...
  const toggleEnabled = (0, import_react2.useCallback)(async () => {
    if (!active) return;
    setBusy(true);
    setNotice("");
    setNoticeIsError(false);
  ...
  const saveDefaultCwd = (0, import_react2.useCallback)(async () => {
    setBusy(true);
    setNotice("");
    setNoticeIsError(false);
    try {
  ...
  const statusOf = (ch) => statusLoaded ? status[ch.id]?.status ?? "idle" : "configured";
  const statusLabel = (s) => {
    switch (s) {
      case "configured":
        return t("channels.status.configured");
      case "connected":
  ...
  const activeStatusKey = statusLoaded ? active ? statusOf(active) : creating ? "connecting" : "idle" : "configured";
  return (0, import_react2.createElement)(
    "div",
    { style: { display: "grid", gap: "14px", padding: "4px 0" } },
    ...
    (0, import_react2.createElement)(
      "div",
      { style: defaultCwdStyle },
      (0, import_react2.createElement)(
        "div",
        { style: { display: "grid", gap: "4px" } },
        (0, import_react2.createElement)("label", { style: labelStyle }, t("global.cwd")),
        (0, import_react2.createElement)(
          "div",
          ...
          (0, import_react2.createElement)("button", {
            ...
            style: { ...ghostStyle2, padding: "8px 14px", whiteSpace: "nowrap" }
          }, t("browse.open")),
          (0, import_react2.createElement)("button", {
            type: "button",
            disabled: busy,
        ...
        (0, import_react2.createElement)("span", { style: hintStyle }, t("global.cwdHint"))
      ),
      ...
      browsing === "global" ? (0, import_react2.createElement)(DirectoryBrowser, {
    ...
    (0, import_react2.createElement)(
      ...
      (0, import_react2.createElement)(
        "div",
        { style: { width: "220px", flex: "0 0 auto", borderRight: "0.5px solid var(--dsw-alias-border-l3)", paddingRight: "12px" } },
        (0, import_react2.createElement)("div", { style: { fontSize: "13px", fontWeight: 600, marginBottom: "8px" } }, t("channels.add")),
        (0, import_react2.createElement)(
          "div",
          { style: { display: "grid", gap: "6px" } },
          ["wechat", "qq", "email", "cmcc", "feishu", "http"].map(
            (type) => (0, import_react2.createElement)(
              "button",
              {
                key: type,
                type: "button",
              ...
              (0, import_react2.createElement)("span", null, typeLabel(type))
            )
          )
        ),
        channels.length > 0 ? (0, import_react2.createElement)(
          "div",
          { style: { marginTop: "14px" } },
          (0, import_react2.createElement)("div", { style: { fontSize: "12px", opacity: 0.7, marginBottom: "6px" } }, t("channels.existing")),
          (0, import_react2.createElement)(
            "div",
            { style: { display: "grid", gap: "6px" } },
            channels.map(
              (ch) => (0, import_react2.createElement)(
                "div",
                {
                  key: ch.id,
                  ...
                  style: {
                    ...
                    cursor: "pointer",
                    fontSize: "13px",
                    border: resolvedActiveId === ch.id ? "0.5px solid var(--dsw-alias-button-primary-fill)" : "0.5px solid var(--dsw-alias-border-l3)",
                    background: resolvedActiveId === ch.id ? "var(--dsw-alias-interactive-bg-hover)" : "transparent"
                  }
                },
                (0, import_react2.createElement)("div", { style: { fontWeight: 600 } }, ch.name),
                (0, import_react2.createElement)(
                  "div",
      ...
      (0, import_react2.createElement)(
        ...
        notice !== "" ? (0, import_react2.createElement)("div", { style: { ...noticeIsError ? dangerStyle : successStyle, fontSize: "12px", marginBottom: "8px" } }, notice) : null,
        creating !== null || active ? (0, import_react2.createElement)(
          "div",
          ...
          // config fields.
          currentType ? (0, import_react2.createElement)(
            "div",
            { style: setupCalloutStyle },
            (0, import_react2.createElement)("div", { style: { fontWeight: 600, fontSize: "12px", marginBottom: "4px" } }, t("channels.setup")),
            (0, import_react2.createElement)("div", { style: { fontSize: "11.5px", opacity: 0.85, marginBottom: "6px" } }, t("type." + currentType + ".desc")),
            (0, import_react2.createElement)(
              "ol",
              { style: { margin: 0, paddingLeft: "18px", fontSize: "11.5px", opacity: 0.9, display: "grid", gap: "3px" } },
              (SETUP_STEPS[currentType] ?? []).map(
                (stepKey) => (0, import_react2.createElement)("li", { key: stepKey }, t(stepKey))
              )
            )
          ) : null,
          ...
          currentType === "wechat" ? (0, import_react2.createElement)(
            "div",
            { style: { fontSize: "12px" } },
            activeQrSvg !== "" ? (0, import_react2.createElement)(
              "div",
              { style: { display: "grid", gap: "6px", justifyItems: "start" } },
              ...
              (0, import_react2.createElement)("a", { href: activeQr, target: "_blank", rel: "noreferrer", style: linkStyle }, t("channels.openQr"))
            ) : activeQr ? (0, import_react2.createElement)("a", { href: activeQr, target: "_blank", rel: "noreferrer", style: linkStyle }, t("channels.openQr")) : activeBound ? (0, import_react2.createElement)("span", { style: { opacity: 0.75 } }, t("channels.bound")) : (0, import_react2.createElement)("span", { style: { opacity: 0.75 } }, t("channels.qrHint"))
          ) : null,
          // Enable / disable switch (existing channels only; new ones start enabled).
          active && !creating ? (0, import_react2.createElement)(
            "div",
            ...
            (0, import_react2.createElement)("button", {
              ...
              style: { ...ghostStyle2, padding: "5px 12px", fontSize: "12px" }
          ...
          (0, import_react2.createElement)(
            "div",
            { style: { display: "grid", gap: "4px" } },
            (0, import_react2.createElement)("label", { style: labelStyle }, t("field.name")),
            (0, import_react2.createElement)("input", { value: draftName, onChange: (e) => setDraftName(e.target.value), style: inputStyle2 })
          ),
          // Email provider picker (only for email).
          currentType === "email" ? (0, import_react2.createElement)(
            "div",
            { style: { display: "grid", gap: "4px" } },
            (0, import_react2.createElement)("label", { style: labelStyle }, t("field.provider")),
            (0, import_react2.createElement)(
              "select",
              {
                value: provider,
              ...
              EMAIL_PROVIDERS.map((p) => (0, import_react2.createElement)("option", { key: p.id, value: p.id }, p.label))
            )
          ) : null,
          ...currentFields.map(
            (f) => (0, import_react2.createElement)(
              "div",
              { key: f.key, style: { display: "grid", gap: "4px" } },
              (0, import_react2.createElement)("label", { style: labelStyle }, t(f.labelKey) + (f.secret && activeSecretSet ? ` (${t("credential.set")})` : "")),
              (0, import_react2.createElement)("input", {
          ...
          (0, import_react2.createElement)(
            "div",
            { style: { borderTop: "0.5px solid var(--dsw-alias-border-l3)", paddingTop: "8px" } },
            (0, import_react2.createElement)("button", {
              type: "button",
              onClick: () => setAdvancedOpen(!advancedOpen),
              style: { ...ghostStyle2, padding: "5px 12px", fontSize: "12px", border: "none", opacity: 0.8 }
            }, t("channels.advanced") + (advancedOpen ? " \u25B4" : " \u25BE")),
            advancedOpen ? (0, import_react2.createElement)(
              "div",
              { style: { display: "grid", gap: "8px", marginTop: "8px" } },
              ADVANCED_KEYS.map((key) => (0, import_react2.createElement)(
                "div",
                { key, style: { display: "grid", gap: "3px" } },
                (0, import_react2.createElement)("label", { style: labelStyle }, t("advanced." + key)),
                key === "allowlist" ? (0, import_react2.createElement)("textarea", {
                  rows: 3,
                  style: { ...inputStyle2, fontFamily: "monospace" },
                  value: draft.allowlist ?? "",
                  onChange: (e) => setDraft((prev) => ({ ...prev, allowlist: e.target.value }))
                }) : key === "cwd" ? (0, import_react2.createElement)(
                  "div",
                  { style: { display: "flex", gap: "8px" } },
                  (0, import_react2.createElement)("input", {
                    style: inputStyle2,
                  ...
                  (0, import_react2.createElement)("button", {
                    ...
                    style: { ...ghostStyle2, padding: "8px 14px", fontSize: "12px", whiteSpace: "nowrap" }
                  }, t("browse.open"))
                ) : (0, import_react2.createElement)("input", {
                  style: inputStyle2,
                  value: draft[key] ?? "",
                ...
                (0, import_react2.createElement)("span", { style: hintStyle }, ADVANCED_HINTS[key] ?? "")
              ))
            ) : null
          ),
          (0, import_react2.createElement)(
            ...
            (0, import_react2.createElement)("button", { type: "button", onClick: () => void save(), disabled: busy, style: primaryStyle2 }, t("channels.save")),
            active ? (0, import_react2.createElement)("button", {
              type: "button",
              onClick: () => void remove(active.id),
              disabled: busy,
              style: { ...ghostStyle2, ...dangerStyle }
            }, confirmingDelete ? t("channels.confirmDelete") : t("channels.delete")) : null
          ),
          ...
          browsing === "channel" ? (0, import_react2.createElement)(DirectoryBrowser, {
        ...
        ) : (0, import_react2.createElement)("p", { style: { opacity: 0.7, fontSize: "14px" } }, t("channels.empty"))
      )
    )
  );
}
...
var labelStyle = { fontSize: "12px", color: "var(--dsw-alias-label-secondary)" };
var setupCalloutStyle = {
  padding: "10px 12px",
  borderRadius: "10px",
  border: "0.5px solid var(--dsw-alias-border-l3)",
...
var dangerStyle = { color: "var(--dsw-alias-state-error-primary)" };
var successStyle = { color: "var(--dsw-alias-state-success-primary)" };
var linkStyle = { color: "var(--dsw-alias-button-info-fill)" };

// src/client/ChannelsCard.tsx
function ChannelsConfigEntry(props) {
  const { form, t, view } = props;
  if (view === "summary") return t("card.description");
  if (view !== "page") return null;
  return (0, import_react3.createElement)("div", { style: pageStyle }, (0, import_react3.createElement)(ChannelsSection, { form, t }));
}
var pageStyle = {
  padding: "4px 0",
  color: "var(--dsw-alias-label-primary)"
